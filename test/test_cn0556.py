...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("boost_output_current_limit", 0.07, 10, 1, 0.01),
        ("report", 0, 1, 1, 1),
        ("fault", 0, 1, 1, 1),
        ("intvcc_voltage", 0, 4, 1, 0.01),
        ("share_voltage", 0, 4, 1, 0.01),
        ("buck_input_voltage", 14, 56, 1, 0.01),
        ("buck_input_current", 0.07, 10, 1, 0.01),
        ("buck_output_current", 0, 35, 1, 0.01),
        ("boost_input_voltage", 14, 56, 1, 0.01),
        ("boost_input_current", 0, 35, 1, 0.01),
        ("boost_output_current", 0.07, 10, 1, 0.01),
    ],
)
